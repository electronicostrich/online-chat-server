...
- **Still deferred** within WS-03 (tracked in `docs/workstream-notes/ws-03-progress.md`): AC-INV-01..04 (private-room invitations), AC-DM-02 (friend-request accept), AC-DM-03 (friend removal freezes DM), AC-AUTH-09 (account-deletion cascade, held from WS-02). The WS-05 `room.membership.updated` / `room.ban.updated` fan-outs for the endpoints that landed here remain a WS-05 concern.
